...
static const uintptr_t MPC_CONTROLLER_NUM_DECISION_VARIABLES = 20;

/// Number of parameters
static const uintptr_t MPC_CONTROLLER_NUM_PARAMETERS = 332;

/// Number of parameters associated with augmented Lagrangian
static const uintptr_t MPC_CONTROLLER_N1 = 15;

/// Number of penalty constraints
static const uintptr_t MPC_CONTROLLER_N2 = 900;

/// mpc_controller version of ExitStatus
/// Structure: `mpc_controllerExitStatus`
enum class mpc_controllerExitStatus {
...
struct mpc_controllerSolverStatus {
  ...
  double lagrange[MPC_CONTROLLER_N1];
};
